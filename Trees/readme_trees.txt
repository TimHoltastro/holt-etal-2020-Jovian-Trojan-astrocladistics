----- Jovian Trojan astrocladistical trees------
...
File type: pdf 
Also available in nexus format from the asosciated Github repository: https://github.com/TimHoltastro/holt-etal-2021-Jovian-Trojan-astrocladistics.git
